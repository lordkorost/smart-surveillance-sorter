...
class ClipBlipEngine:
    def __init__(self, settings, cameras_config, mode,device):
        ...
        self.clip_model, self.preprocess, _ = create_model_and_transforms(
            self.clip_blip_settings.get("clip_model"),
            pretrained=self.clip_blip_settings.get("clip_pretrained"))
        ...
        self.priority_hierarchy = settings.get("classification_settings").get("priority_hierarchy")
